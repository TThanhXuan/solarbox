...
- Mình có nhận setup box hoàn chỉnh tùy theo nhu cầu. [Bảng giá](https://github.com/TThanhXuan/SolarBox/tree/main/docs/sale/README.md) Hiện tại mình không nhận setup nữa nha mọi người
